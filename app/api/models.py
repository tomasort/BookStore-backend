...
class Author(db.Model):
    ...
    books: so.WriteOnlyMapped[list['Book']] = so.relationship('Book', back_populates='author')
...
class Book(db.Model):
    ...
    author_id: so.Mapped[Optional[int]] = so.mapped_column(sa.Integer, sa.ForeignKey('author.id'))
    ...
    author: so.WriteOnlyMapped[Optional['Author']] = so.relationship('Author', back_populates='books')
    genres: so.WriteOnlyMapped[list['Genre']] = so.relationship('Genre', secondary=book_genres, back_populates='books')
    publisher: so.WriteOnlyMapped[Optional['Publisher']] = so.relationship('Publisher', back_populates='books')
    languages: so.WriteOnlyMapped[list['Language']] = so.relationship('Language', secondary=book_languages, back_populates='books')
    series: so.WriteOnlyMapped[list['Series']] = so.relationship('Series', secondary=book_series, back_populates='books')
...
class Genre(db.Model):
    ...
    # Define the relationship with books
    books: so.WriteOnlyMapped[list['Book']] = so.relationship('Book', secondary=book_genres, back_populates='genres')
...
class Publisher(db.Model):
    ...
    # Define the relationship with books
    books: so.WriteOnlyMapped[list['Book']] = so.relationship('Book', back_populates='publisher')
...
class Language(db.Model):
    ...
    # Define the relationship with books
    books: so.WriteOnlyMapped[list['Book']] = so.relationship('Book', secondary=book_languages, back_populates='languages')
...
class Series(db.Model):
    ...
    # Define the relationship with books
    books: so.WriteOnlyMapped[list['Book']] = so.relationship('Book', secondary=book_series, back_populates='series')
